...
var evaluateTests map[string]expressionTest = map[string]expressionTest{
	"Flat Struct": {
		...
		[]expressionCheck{
			{expression: "5 >= 10 / 2", result: true, benchQuick: true},
			{expression: "12.0 == 10.0 * Float64", result: true, benchQuick: true},
			{expression: "12.0 == Float64 * 10.0", result: true, benchQuick: true},
			{expression: "Float64 == 1.2 * 1.0", result: true, benchQuick: true},
			{expression: "Uint == 3 * 2", result: true, benchQuick: true},
			{expression: "2 == 2 / 1", result: true, benchQuick: true},
			{expression: "1 == 1 / 1", result: true, benchQuick: true},
			{expression: "1 == 1 * 1", result: true, benchQuick: true},
			{expression: "1 == 1 - 2", result: false, benchQuick: true},
			{expression: "Int == 1 - 2", result: true, benchQuick: true},
			{expression: "Int <= Int", result: true, benchQuick: true},
			{expression: "Int == 1 + 2", result: false, benchQuick: true},
			{expression: "Int < 1", result: true, benchQuick: true},
			{expression: "Int < -1", result: false, benchQuick: true},
			{expression: "Int < -2", result: false, benchQuick: true},
			{expression: "Int <= 1", result: true, benchQuick: true},
			{expression: "Int <= -1", result: true, benchQuick: true},
			{expression: "Int <= -2", result: false, benchQuick: true},
			{expression: "Int > 1", result: false, benchQuick: true},
			{expression: "Int > -1", result: false, benchQuick: true},
			{expression: "Int > -2", result: true, benchQuick: true},
			{expression: "Int >= -2", result: true, benchQuick: true},
			{expression: "Int >= -1", result: true, benchQuick: true},
			{expression: "Int >= 1", result: false, benchQuick: true},
			{expression: "Int == -1", result: true, benchQuick: true},
	...
	"Nested Structs and Maps": {
		...
		[]expressionCheck{
			...
			{expression: `"/Nested/SliceOfInts" == "7"`, result: false, err: `unable to find suitable primitive comparison function for matching []int and string`},
			...
			{expression: "\"Map\" in Nested", result: false, err: "Cannot perform in/contains operations on type struct"},
